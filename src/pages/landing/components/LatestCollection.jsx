...
const LatestCollection = () => {
  return (
    ...
    <div className="container bg-white">
       ...
       <div className="col-md-6">
          <div className="box  " >
               ...
               <img src='https://i.ibb.co/ZVz4pkY/arrival-bg-removebg-preview-1.png' alt='the 'style={{height:'600px'}} />
            </div>
          </div>
          ...
          <div className="row mt-5">
                  {/* <div className="col-md-6 ml-auto"> */}
                     <div className="heading_container remove_line_bt mt-5">
    ...
    color: '#ffffff', width:'50%', borderRadius:'5px'}} className='mx-1' >
                     See Latest Products
                     </p>
                  {/* </div> */}
               </div>
